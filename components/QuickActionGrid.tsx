    ...
    <div className="grid grid-cols-2 gap-4">
      {quickActions.map((action) => (
        <button
          ...
          className="focus-ring group min-h-28 rounded-2xl border border-line bg-white/[0.07] p-4 text-left shadow-soft transition hover:-translate-y-0.5 hover:bg-white/[0.11]"
        >
